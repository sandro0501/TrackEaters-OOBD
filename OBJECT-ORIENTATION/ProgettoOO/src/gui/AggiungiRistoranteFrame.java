...
public class AggiungiRistoranteFrame extends JFrame {
	...
	public AggiungiRistoranteFrame(Controller c) {
		...
		etichetta_Ristorante.setIcon(new ImageIcon(AggiungiRistoranteFrame.class.getResource("/resources/lblAggiungiRistorante.png")));
		...
		JLabel lblAggiungi = new JLabel("Sei sicuro di voler inserire il nuovo ristorante?");
