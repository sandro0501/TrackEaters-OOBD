...
public class AggiungiTavolataFrame extends JFrame {
	...
	public AggiungiTavolataFrame(Controller c, boolean isProprietario) {
		
		theController = c;
		
		setResizable(false);
		setIconImage(Toolkit.getDefaultToolkit().getImage(ModificaAvventoreFrame.class.getResource("/resources/icon.png")));
		setTitle("TrackEaters - Aggiungi tavolata al tavolo");
		...
		etichetta_Tavolate.setIcon(new ImageIcon(AggiungiTavolataFrame.class.getResource("/resources/aggiungiTavolataTitle.png")));
		...
		JLabel lblAggiungi = new JLabel("Sei sicuro di voler inserire la nuova tavolata?");
	...
	private void mostraAnnullaDialog(Controller c) {
		JLabel lblAnnulla = new JLabel("Sei sicuro di voler annullare l'inserimento della nuova tavolata?");
