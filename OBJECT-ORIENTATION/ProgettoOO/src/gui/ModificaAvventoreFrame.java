...
public class ModificaAvventoreFrame extends JFrame {
	...
	public ModificaAvventoreFrame(Controller c, boolean isProprietario) {
		
		theController = c;
		
		setResizable(false);
		setIconImage(Toolkit.getDefaultToolkit().getImage(ModificaAvventoreFrame.class.getResource("/resources/icon.png")));
		setTitle("TrackEaters - Gestione Sale e Tavolate - Modifica avventore");
		...
		etichetta_Avventori.setIcon(new ImageIcon(ModificaAvventoreFrame.class.getResource("/resources/modificaAvventoreTitle.png")));
		...
		campo_NumCid.setEditable(false);
		...
		JLabel lblAggiungi = new JLabel("Sei sicuro di voler modificare le informazioni dell'avventore?");
		...
		bottone_Modifica.setIcon(new ImageIcon(ModificaAvventoreFrame.class.getResource("/resources/btnModifica.png")));
		bottone_Modifica.setBounds(930, 607, 160, 60);
	...
	private void mostraAnnullaDialog(Controller c) {
		JLabel lblAnnulla = new JLabel("Sei sicuro di voler annullare le modifiche all'avventore?");
	...
	public JTextField getCampo_NumCid() {
		return campo_NumCid;
	}
	...
	public JDateChooser getCampo_DataNascita() {
		return campo_DataNascita;
	}

	public JComboBox getCampo_Sesso() {
		return campo_Sesso;
	}

	public JTextField getCampo_CittaNascita() {
		return campo_CittaNascita;
	}
	...
	public JComboBox getCampo_ProvNascita() {
		return campo_ProvNascita;
	}

	public JComboBox getCampo_ProvResidenza() {
		return campo_ProvResidenza;
	}
	...
	public JSpinner getCampo_Temperatura() {
		return campo_Temperatura;
	}

	public JComboBox getCampo_Greenpass() {
		return campo_Greenpass;
	}
}
