...
public class ModificaSalaFrame extends JFrame {
	...
	public ModificaSalaFrame(Controller c, boolean isProprietario) {
		...
		etichetta_Sala.setIcon(new ImageIcon(ModificaSalaFrame.class.getResource("/resources/modificaSala_title.png")));
		...
		etichetta_Capienza.setIcon(new ImageIcon(ModificaSalaFrame.class.getResource("/resources/capienzaIcon.png")));
		...
		etichetta_DimensioneMq.setIcon(new ImageIcon(ModificaSalaFrame.class.getResource("/resources/dimensioneIcon.png")));
		...
		etichetta_TipologiaSala.setIcon(new ImageIcon(ModificaSalaFrame.class.getResource("/resources/tipologiaIcon.png")));
		...
		campo_DimensioneMq.setModel(new SpinnerNumberModel(new Integer(0), null, null, new Integer(10)));
		...
		JLabel lblAggiungi = new JLabel("Sei sicuro di voler modificare le informazioni della sala?");
		...
		bottone_Modifica.setIcon(new ImageIcon(ModificaSalaFrame.class.getResource("/resources/btnModifica.png")));
	...
	private void mostraAnnullaDialog(Controller c) {
		JLabel lblAnnulla = new JLabel("Sei sicuro di voler annullare la modifica delle informazioni della sala?");
	...
	public JSpinner getCampo_CapienzaAvventori() {
		return campo_CapienzaAvventori;
	}

	public JSpinner getCampo_DimensioneMq() {
		return campo_DimensioneMq;
	}

	public JComboBox getCampo_TipologiaSala() {
		return campo_TipologiaSala;
	}
}
