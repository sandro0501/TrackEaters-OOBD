...
public class Modifica_Tavolata extends JFrame {
	...
	public Modifica_Tavolata(Controller c, boolean proprietario) {
		
		theController = c;
		
		setResizable(false);
		setIconImage(Toolkit.getDefaultToolkit().getImage(Aggiungi_Tavolata.class.getResource("/resources/icon.png")));
		setTitle("SecuRisto");
