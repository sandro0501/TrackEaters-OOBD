...
(
	...
	Email				VARCHAR2(320)		  ,
	Telefono			VARCHAR2(15)  NOT NULL,
	RistoranteGestito	INTEGER 	  NOT NULL
);
...
(
	-- Vincolo di chiave primaria
	CONSTRAINT PK_MANAGER PRIMARY KEY (CodManager),
	...
	-- Vincolo Email legale
	CONSTRAINT EMAIL_LEGALE_MANAGER CHECK (Email LIKE '_%@_%.__%' OR Email IS NULL),
	
	-- Vincolo Unico username manager
	CONSTRAINT UNICO_USERNAME_MANAGER UNIQUE (Username)
);
